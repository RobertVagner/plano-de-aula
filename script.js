function generateSpecificTopic() {
    ...
    let output = `<h2 style="text-align: center;">Gere um tópico específico sobre ${subject}</h2><ol>`;
    ...
    selectedSections.forEach(section => {
        switch (section) {
            ...
            case 'projeto':
                ...
                break;
            case 'metodologia':
                output += `<li><strong>Metodologia:</strong> Gere em tópicos a metodologia de ensino que será utilizada para conduzir as aulas.</li>`;
                break;
            case 'recAux':
...
// Função para obter as seções selecionadas
...
// Mantenha a função generateSpecificTopic como estava anteriormente
function generatePlan() {
    ...
    const specificTopic = `
        <h2>Crie um plano de ensino de nível ${drop} para o curso de ${subject1}, na disciplina de ${subject}.</h2>
        <p> Elabore um plano de ensino sobre ${subject} no curso de ${subject1}. Onde deverá abordar
            ...
            detalhado do conteúdo do curso. O método de avaliação será feito através de ${avaliacao}. Deverá ser incluso também ${ref1} referências
